...
class _UploadPageState extends State<UploadPage> with AutomaticKeepAliveClientMixin<UploadPage>
{
  ...
  takeImage(mContext){
    return showDialog(
      ...
      builder: (context){
        return SimpleDialog(
          title: Text("New Gist", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),),
          children: [
            SimpleDialogOption(
  ...
  displayUploadScreen(){
    return Container(
      ...
      child: Column(
        ...
        children: [
          Icon(Icons.add_photo_alternate, color: Colors.grey, size: 150.0,),
          Padding(
            padding: EdgeInsets.only(top: 20.0),
            child: RaisedButton(
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(9.0),),
              child: Text("Upload Image", style: TextStyle(color: Colors.black, fontSize: 20.0),),
              color: kPrimaryColor,
      ...
      appBar: AppBar(
        ...
        actions: [
          FlatButton(
            ...
            child: Text("Share", style: TextStyle(color: kPrimaryColor, fontWeight: FontWeight.bold, fontSize: 16.0),),
          ),
        ],
      ),
      body: ListView(
